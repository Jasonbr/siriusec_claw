...
func NewHub(version string) *Hub {
	methods := []string{
		...
		"mcp.list", "mcp.get", "mcp.add", "mcp.update", "mcp.delete", "mcp.install",
		"models.list",
		"agents.list", "agents.create", "agents.update", "agents.delete",
		"agents.files.list", "agents.files.get", "agents.files.set",
		"employees.list", "employees.get", "employees.create", "employees.update", "employees.upload", "employees.install", "employees.delete",
